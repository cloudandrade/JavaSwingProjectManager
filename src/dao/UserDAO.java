...
public class UserDAO {
	...
	private static String ADD_USER = "INSERT INTO USER " + "(name, username, email, phone, password) "
			+ "VALUES (?,?,?,?,?)";

	private static String LIST_USERS = "SELECT * FROM USER";

	private static String FIND_USER = "SELECT * FROM USER " + "WHERE id = ? ";

	private static String FIND_USER_BY_EMAIL = "SELECT * FROM USER " + "WHERE email = ? ";

	private static String UPDATE_USER = "UPDATE USER SET "
			+ "name = ?, username = ?, email = ?, phone = ?, password = ? " + "WHERE id = ?";
